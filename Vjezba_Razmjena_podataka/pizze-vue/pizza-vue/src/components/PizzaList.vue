<template>
    <div class="mx-auto bg-linear-to-br min-h-screen p-8 pb-32 bg-[url('/background.png')] bg-cover bg-center bg-no-repeat">
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div 
                ...
                odabrana_pizza && odabrana_pizza.naziv === pizza.naziv
                ...
                <div class="p-6">
                    ...
                    <div class="flex items-center space-x-3 mb-4">
                        ...
                        <div class="flex space-x-2">
                            <div v-for="sastojak in pizza.sastojci" 
                                :key="sastojak" 
    ...
    <OrderFooter v-if="odabrana_pizza" :odabranaPizza="odabrana_pizza" @close="odabrana_pizza = null" />
</template>
...
<script setup>
    ...
    async function fetchPizze() {
        try {
            ...
            console.log("Dobili smo pizze:", response.data);
    ...
    const ikoneSastojaka = {
        ...
        šunka: 'gi-ham-shank',
        feferoni_ljuti: 'la-pepper-hot-solid',
        tunjevina: 'gi-canned-fish',
        crveni_luk: 'gi-garlic',
        panceta: 'fa-bacon',
        kulen: 'co-hotjar',
