...
Potrebno je još provjeriti je li Node.js instaliran, to radimo kroz terminal sa naredbom "node -v", ako nije instaliran potrebno ga je ga instalirati
...
Zatim je potrebno otvoriti još jedan terminal u kojem se otvara subdirectory pizze-vue te u njemu pizza-vue, u tom teminalu se pokreće Vue dio projekta (Vue server) sa "npm run dev" na taj način pokrečemo frontend 
